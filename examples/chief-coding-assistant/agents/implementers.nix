...

{
  opencode.agent = {
    bash-expert = {
      ...
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/bash-expert.md;
    };
    ...
    cuda-expert = {
      ...
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/cuda-expert.md;
    };
    ...
    haskell-expert = {
      ...
      mode = "subagent";
      model = "{env:OPENCODE_MODEL_IMPLEMENTER_SMALL}";
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/haskell-expert.md;
    };
    ...
    nix-devops-expert = {
      ...
      mode = "subagent";
      model = "{env:OPENCODE_MODEL_IMPLEMENTER_BIG}";
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/nix-devops-expert.md;
    };
    ...
    python-expert = {
      ...
      mode = "subagent";
      model = "{env:OPENCODE_MODEL_IMPLEMENTER_SMALL}";
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/python-expert.md;
    };
    ...
    rescript-react-expert = {
      ...
      mode = "subagent";
      model = "{env:OPENCODE_MODEL_IMPLEMENTER_SMALL}";
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/rescript-react-expert.md;
    };
    ...
    rust-expert = {
      ...
      mode = "subagent";
      model = "{env:OPENCODE_MODEL_IMPLEMENTER_SMALL}";
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/rust-expert.md;
    };
    ...
    tla-expert = {
      ...
      mode = "subagent";
      model = "{env:OPENCODE_MODEL_IMPLEMENTER_BIG}";
      prompt = builtins.readFile ./prompts/SYSTEM_PROMPT.md + "\n" + builtins.readFile ./prompts/tla-expert.md;
    };
  };
}
