...
- `goto_definition` — jump to definitions precisely (no false positives)
- `find_references` — find all usages to discover pattern adoption
- `hover` — get type signatures to understand patterns
